...
<head>
  ...
  <body style="background-color: #5693a9">
    ...
    <div class="container" style="margin-top:130px">
      ...
      <div class="row">
        <a style="text-color: white; text-decoration: none" href="add.php"><button type="button" class="btn btn-success btn-lg">Add a new puzzle flag</button></a>
        <a style="text-color: white; text-decoration: none" href="del.php"><button type="button" class="btn btn-danger btn-lg">Delete a puzzle flag</button></a>
        <a style="text-color: white; text-decoration: none" href="list.php"><button type="button" class="btn btn-info btn-lg">List all puzzle current names, points and flags that are stored in the database</button></a>
      </div>
    </div>
